!function(e) {
  ...
  class O {
    ...
    _initObservers() {
      C(this, x, new MutationObserver(e=>{
        ...
        C(this, A, new MutationObserver(e=>{
            e.forEach(e=>{
                e.addedNodes.forEach(e=>{
    ...
    _initAddons() {
      ...
      for (let e in O.addons) {
        if (e !== 'ownCarousel')
        O.addons[e].call(this);
      }
    ...
    _initPanel(e) {
      var t;
      if (!e.matches(".mm-panel") && (P(e, this.conf.classNames.panel, "mm-panel"),
    ...
    _initNavbar(e) {
      if (_(e, ".mm-navbar").length)
        return;
      let t = null
        , n = null;
      if (e.dataset.mmParent)
        for (t = L(this.node.pnls, "#" + e.dataset.mmParent)[0],
    ...
    _initListview(e) {
      ["htmlulistelement", "htmlolistelement"].includes(o(e)) && (e.matches(".mm-listview") || (P(e, this.conf.classNames.nolistview, "mm-nolistview"),
    ...
    _initListitem(e) {
      ["htmllielement"].includes(o(e)) && (e.matches(".mm-listitem") || (P(e, this.conf.classNames.divider, "mm-divider"),
    ...
    _initSubPanel(e) {
      ...
      let n = _(t, ".mm-btn")[0];
      n || (n = g("a.mm-btn.mm-btn--next.mm-listitem__btn"),
  ...
  O.prototype.position = function(e=null) {
    ...
    if (!e)
      return t.position;
    q.includes(e) && (this.node.wrpr.classList.remove("mm-wrapper--position-" + t.position),
  ...
  O.prototype.theme = function(e=null) {
    ...
    if (!e)
      return t;
    R.includes(e) && (this.node.menu.classList.remove("mm-menu--theme-" + t),
  ...
  function z() {
    ...
    if (void 0 !== e && (e instanceof Array || (e = [e]),
      ...
      e.forEach(e=>{
          ...
          ;
          "boolean" == typeof e.use ? this.bind("initMenu:after", i) : M(e.use, i, a)
        }
      ),
  ...
  const te = function() {
      ...
      return n || (n = g("div.mm-panel--search"),
        me(n, t.panel),
    ...
    , ie = function(e) {
      const t = this.opts.searchfield
        ...
        , s = L(e, "input")[0];
      let i = n.matches(".mm-panel--search") ? _(this.node.pnls, t.searchIn) : [n];
      ...
      const a = ()=>{
          ...
          if (i.forEach(e=>{
            ...
            this.trigger("clear:before"),
              ...
              n.matches(".mm-panel--search") ? (oe(n),
              t.splash || this.closePanel(n, !1, !1)) : le(i),
      ...
      return t.forEach(t=>{
          ...
          s.length && s.forEach(t=>{
            ...
            L(t, ".mm-listitem, .mm-divider").forEach(t=>{
                t.classList.add("mm-hidden"),
                t.dataset.mmSearchresult === e && [t, ...w(t, ".mm-listitem")].forEach(e=>{
...
*/
  O.addons = {
    offcanvas: function() {
      ...
      e.use && (q.includes(e.position) || (e.position = q[0]),
      ...
      O.node.blck || this.bind("initMenu:before", ()=>{
    ...
    scrollBugFix: function() {
      if (!B || !this.opts.offCanvas.use)
        return;
      this.opts.scrollBugFix = this.opts.scrollBugFix || {};
      if (!a(this.opts.scrollBugFix, I).fix)
        return;
      const e = (e=>{
          let t = ""
            , n = null;
      ...
      this.node.menu.addEventListener("scroll", e=>{
        ...
        this.node.menu.addEventListener("touchmove", t=>{
            ...
            n && n.closest(".mm-listitem--vertical") && (n = w(n, ".mm-panel").pop()),
        ...
        this.bind("open:after", ()=>{
          ...
          window.addEventListener("popstate", e=>{
              if (this.node.menu.matches(".mm-menu--opened") && n.length) {
                ...
                s == t ? this.close() : (this.openPanel(this.node.menu.querySelector(s)),
                  history.pushState(null, document.title, t))
              }
            }
          )
    ...
    iconbar: function() {
      ...
      if (["top", "bottom"].forEach((n,s)=>{
          ...
          a.children.length && (t || (t = g("div.mm-iconbar")),
            t.append(a))
        }
      ),
        t) {
        ...
        ;
        if ("boolean" == typeof e.use ? this.bind("initMenu:after", s) : M(e.use, s, i),
        "tabs" == e.type) {
      ...
      if ("first" == e.visible && (t = !0,
        ...
        t ? this.bind("initMenu:after", ()=>{
          ...
          this.bind("initPanel:after", e=>{
              if (!e.closest(".mm-listitem--vertical") && !_(e, ".mm-panel__blocker")[0]) {
    ...
    pageScroll: function() {
      ...
      if (this.opts.offCanvas.use && e.scroll && (this.bind("close:after", ()=>{
        ...
        this.node.menu.addEventListener("click", e=>{
            ...
            (n = i(o)) && (e.preventDefault(),
              this.node.menu.matches(".mm-menu--sidebar-expanded") && this.node.wrpr.matches(".mm-wrapper--sidebar-expanded") ? s() : this.close())
          }
        )),
        e.update) {
        let e = [];
    ...
    searchfield: function() {
      ...
      if (e.add) {
        ...
        this.bind("initPanel:after", t=>{
            t.matches(e.addTo) && !t.closest(".mm-listitem--vertical") && ne.call(this, t)
          }
        ),
          this.bind("initMenu:after", ()=>{
    ...
    sectionIndexer: function() {
      ...
      a(this.opts.sectionIndexer, ce).add && this.bind("initPanels:after", ()=>{
          if (!this.node.indx) {
            let e = "";
            ...
            let n = e=>{
                ...
                let s = -1
                  , i = n.scrollTop;
                n.scrollTop = 0,
                  L(n, ".mm-divider").filter(e=>!e.matches(".mm-hidden")).forEach(e=>{
            ...
            ;
            B ? (this.node.indx.addEventListener("touchstart", n),
    ...
    sidebar: function() {
      ...
      if (e.collapsed.use) {
        this.bind("initMenu:after", ()=>{
            if (this.node.menu.classList.add("mm-menu--sidebar-collapsed"),
        ...
        ;
        "boolean" == typeof e.collapsed.use ? this.bind("initMenu:after", t) : M(e.collapsed.use, t, n)
      }
      if (e.expanded.use) {
        this.bind("initMenu:after", ()=>{
        ...
        ;
        "boolean" == typeof e.expanded.use ? this.bind("initMenu:after", n) : M(e.expanded.use, n, s),
          this.bind("close:after", ()=>{
